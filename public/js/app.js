...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    editText: function editText(newVal, oldVal) {
      this.text = newVal;
    }
  }
});
...
/* harmony import */ var _CommentForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CommentForm */ "./resources/js/components/CommentForm.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    sowFormLink: function sowFormLink() {
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    ...
    _c("main", [
      _c(
        "div",
        { staticClass: "article mt-4" },
        [_vm._m(1), _vm._v(" "), _c("Comments")],
        1
      )
    ])
  ])
...
var staticRenderFns = [
    ...
    return _c("header", [
      _c("nav", { staticClass: "navbar navbar-dark bg-dark" }, [
        _c("a", { staticClass: "navbar-brand", attrs: { href: "#" } }, [
          _c("h1", [_vm._v("Solar Digital Test")])
        ])
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "jumbotron" }, [
      _c("h2", { staticClass: "display-4" }, [_vm._v("Hello, world!")]),
      _vm._v(" "),
      _c("p", { staticClass: "lead" }, [_vm._v("This is an article text.")])
    ])
  }
]
...
var render = function() {
  ...
  return _c("div", { staticClass: "media mt-3" }, [
    _c("img", {
      staticClass: "mr-3",
      attrs: { src: "http://placekitten.com/64/64", alt: "" }
    }),
    _vm._v(" "),
    _c(
      "div",
      ...
      [
        _c("h5", [_c("small", [_vm._v(_vm._s(_vm.comment.updated_at))])]),
        ...
        _vm._l(_vm.comment.replies, function(reply, index) {
          return _vm.comment.replies
            ? _c("Comment", {
                key: reply.id,
                attrs: { comment: reply, index: index }
              })
            : _vm._e()
        })
      ],
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    FETCH: function FETCH(state, comments) {
      function getNestedComments(comments, parent) {
        var nestestedComments = [];

        for (var i in comments) {
          if (comments[i].parent === parent) {
            var replies = getNestedComments(comments, comments[i].id);
  ...
  actions: {
    fetch: function fetch(_ref) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/api/comments").then(function (response) {
    ...
    deleteComment: function deleteComment(_ref2, id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a["delete"]("/api/comments/".concat(id)).then(function () {
        return _this.dispatch('fetch');
      })["catch"]();
    },
    editComment: function editComment(_ref3, comment) {
      var _this2 = this;

      _objectDestructuringEmpty(_ref3);

      axios__WEBPACK_IMPORTED_MODULE_2___default.a.put("/api/comments/".concat(comment.id), {
        text: comment.text
      }).then(function () {
        return _this2.dispatch('fetch');
      });
    },
    addComment: function addComment(_ref4, payload) {
      var _this3 = this;

      _objectDestructuringEmpty(_ref4);

      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("/api/comments", payload).then(function () {
...
__webpack_require__(/*! /Users/max/Projects/solar_task/assets/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/max/Projects/solar_task/assets/resources/sass/app.scss */"./resources/sass/app.scss");
